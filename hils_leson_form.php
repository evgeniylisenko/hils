...
<form action="./action.php" method="POST" enctype="multipart/form-data">
	...
	<br>
	<span>Я соглашаюсь на обработку данных</span> <input type="checkbox" name="dataprocessing[]" value="">
	<br>
	<p> Укажите свой пол </p>
	<span> Мужской </span><input type="radio" name="sex[]" value="">
	<span> Женский </span><input type="radio" name="sex[]" value="">
	<br>
